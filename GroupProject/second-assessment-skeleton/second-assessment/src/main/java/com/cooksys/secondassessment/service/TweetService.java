...
public class TweetService {
	...
	public TweetWithIdDto getById(Integer id) {
		TweetWithIdDto tweet = tMapper.tWithIdDto(tRepo.findOne(id));
		if (tweet != null) {
			return tweet;			
		}
	...
	public Tweet deleteById(Integer id) {
		if (tRepo.exists(id)) {
			Tweet tweet = tMapper.toTweet(getById(id));
	...
	public Tweet replyToTweetById(TweetCreateSimpleDto simpleDto, Integer id) {
		...
		Tweet replyToTweet = tMapper.toTweet(getById(id));
